    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <form wire:submit.prevent="save" class="bg-white dark:bg-gray-800 p-6 rounded-lg space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        @foreach($educations as $index => $education)
                            <div class="border border-gray-200 rounded p-4">
                                <div class="grid sm:grid-cols-3 gap-4" style="grid-template-columns: 2fr 0.5fr 0.5fr">
                                    <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea wire:model="educations.{{ $index }}.description"
                                              ...
                                              class="form-textarea rounded-md shadow-sm mt-1 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                              rows="3"></textarea>
                    ...
                    <div class="space-y-4">
                        ...
                        @foreach($experiences as $index => $experience)
                            <div class="border border-gray-200 rounded p-4">
                                <div class="grid gap-4" style="grid-template-columns: 2fr 0.5fr 0.5fr">
                                    <div class="mb-4">
